...
## Rscript metamodule_test.R /home/maria/Documents/TFG /home/maria/Documents/TFG/datasets.lis 
...
#"directory of datasets to be included in metaatlas: /home/maria/Documents/TFG/datasets.lis"
print(paste(".lis file listing datasets:", args[1]))
# ".lis file listing datasets: /home/maria/Documents/TFG"
print(paste("directory of datasets to be included in metaatlas:", args[2]))
"prefix for metaatlas output files: metaatlas"
print(paste("prefix for metaatlas output files:", args[3]))
"gene score pctl minimum for cluster marker filtration: 0.9"
...
# Load the metadata 
dataset.lis <- read.table("meta.tsv", header=T, sep="\t", as.is=T, row.names=1)
...
so <- CreateSeuratObject(counts = mat, project = "adultPancreas", meta.data=dataset.lis)
print(so)
